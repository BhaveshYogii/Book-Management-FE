            ...
            <div className="container pb-8 sm:pb-0">
                <div className="grid grid-cols-1 sm:grid-cols-2">
                    ...
                    <div data-aos-once="true" className='flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1'>
                        <h1 data-aos="zoom-out" data-aos-duration="500" data-aos-once="true" className='text-5xl sm:text-6xl lg:text7xl font-bold'>
                            {title}
                            <p data-aos="slide-up" data-aos-duration="500" data-aos-delay="100 " className='bg-clip-text text-transparent bg-gradient-to-r from-primary text-right text-sm        to-secondary'>
                                 by {author}
                            </p>
                        </h1>
                        <p data-aos="slide-up" data-aos-duration="500" data-aos-delay="100 " className='text-sm'>{description}
                        </p>
                        {/* <div>
                            <button
                  ...
                  data-aos-once="true" src={imageId} alt="" 
                    ...
                    <div className='flex lg:flex-col lg:top-1/2 lg:-translate-y-1/2 lg:py-2 justify-center gap-4 absolute -bottom-[40px] lg:-right-1 bg-white rounded-full'>
                        {
                            ImageList.map((item,index)=>(
                                <img key={index} src={item.img} data-aos="zoom-in"
